...
class LoanScenario(BaseScenario):
    def generate(self, seed: int, bias_magnitude: float = 1.0) -> Tuple[pd.DataFrame, Dict]:
        ...
        # 2. Proxy Variables
        # Zip code strongly proxies race
        ...
        # Income generation (Historical disparity injected)
        ...
        # FICO Score (Correlated with income, therefore indirectly proxying race)
        ...
        # 4. Target Variable Generation (Loan Approval)
        # Approval heavily weights FICO and DTI
        approval_score = (fico_score * 0.5) - (debt_to_income * 500) + (employment_length * 5)
        ...
        # 5. Compute Ground Truth Metrics
